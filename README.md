...
├── notebooks/03_imbalance_and_modeling.ipynb
├── notebooks/04_evaluation_and_calibration.ipynb
├── notebooks/05_explainability_and_scorecard.ipynb
...
The raw CSV and the train/val/test splits aren't checked in (too large) — everything else (iv_table.csv, model_comparison.csv, decision_config.json, the fitted models under joblib/) is committed
